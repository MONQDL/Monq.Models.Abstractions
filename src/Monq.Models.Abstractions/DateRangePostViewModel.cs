...
namespace Monq.Models.Abstractions
{
    ...
    public class DateRangePostViewModel
    {
        ...
        [Range(1, long.MaxValue, ErrorMessage = "Недопустимое значение начальной точки диапазона дат в формате Unixtimestamp.")]
        ...
        [Range(1, long.MaxValue, ErrorMessage = "Недопустимое значение конечной точки диапазона дат в формате Unixtimestamp.")]
